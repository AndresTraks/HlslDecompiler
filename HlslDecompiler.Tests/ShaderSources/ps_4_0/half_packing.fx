...
float4 main(float2 texcoord : TEXCOORD) : SV_Target
{
	...
	int t15 = (((uint)t0.x >> 16) & 32768) + (((t0.x & 2139095040) == 2139095040 ? t1.z ? ((t0.x | (((uint)t0.x >> 13) | ((uint)t0.x >> 3))) & 1023) + 31744 : 31744 : (uint)t1.w > 1207951360 ? 31743 : (uint)t1.w < 947912704 ? (t2.y < 24 ? (uint)t1.z + 8388608 >> t2.y : 0) >> 13 : (uint)t1.w - 939524096 >> 13) & 32767);
	int t16 = t3 + t15;
