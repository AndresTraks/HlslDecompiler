...
float4 main(float2 texcoord : TEXCOORD) : SV_Target
{
	...
	int t3 = ((((uint)t0.y >> 16) & 32768) + (((t0.y & 2139095040) == 2139095040 ? t1.x ? ((t0.y | (((uint)t0.y >> 13) | ((uint)t0.y >> 3))) & 1023) + 31744 : 31744 : t1.y > 1207951360 ? 31743 : t1.y < 947912704 ? (uint)(t2.x < 24 ? (uint)t1.x + 8388608 >> t2.x : 0) >> 13 : (uint)t1.y - 939524096 >> 13) & 32767)) * 65536;
	int t4 = (uint)t3 >> 16;
	...
	int t14 = t5.y ? 10 - ((uint)(t11 ? t11 : t10) >> 1 ? t13 + 1 : t13) : 11;
	int t15 = (((uint)t0.x >> 16) & 32768) + (((t0.x & 2139095040) == 2139095040 ? t1.z ? ((t0.x | (((uint)t0.x >> 13) | ((uint)t0.x >> 3))) & 1023) + 31744 : 31744 : t1.w > 1207951360 ? 31743 : t1.w < 947912704 ? (uint)(t2.y < 24 ? (uint)t1.z + 8388608 >> t2.y : 0) >> 13 : (uint)t1.w - 939524096 >> 13) & 32767);
	int t16 = t3 + t15;
	int3 t17 = t16 & int3(31744, 65535, 1023);
	int t18 = (t17.y * 8192) & 8380416;
	int t19 = (uint)t17.z >> 8;
	int t20 = t19 ? t19 : t17.z;
	int t21 = (uint)t20 >> 4;
	int t22 = t21 ? t21 : t20;
	int t23 = (uint)t22 >> 2;
	int t24 = t21 ? t19 ? 12 : 4 : t19 ? 8 : 0;
	int t25 = t23 ? t24 + 2 : t24;
	int t26 = t17.z ? 10 - ((uint)(t23 ? t23 : t22) >> 1 ? t25 + 1 : t25) : 11;
