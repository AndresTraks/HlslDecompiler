...
float4 main(PS_IN i) : SV_Target
{
	...
	float3 t1 = 2 * normal0.Sample(samp, float2(0.0199999996 * time + i.texcoord2.x, i.texcoord2.y)).xyz - 1 + 2 * normal1.Sample(samp, float2(1.70000005 * i.texcoord2.x, 1.70000005 * i.texcoord2.y - 0.0130000003 * time)).xyz - 1;
	float t2 = length(t1);
	float2 t3 = t1.xz / t2;
