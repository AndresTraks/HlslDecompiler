...
float4 main(float2 texcoord : TEXCOORD) : SV_Target
{
	...
	return float4(asfloat(((t15 * 65536) & -2147483648) + ((t17.x ? t17.x == 31744 ? t18 + 2139095040 : ((((uint)t17.y >> 10) * 8388608) & 260046848) + 939524096 + t18 : t17.z ? 947912704 - (t26 * 8388608) + (((t17.z << t26) * 8192) & 8380416) : 0) & 2147475456)), asfloat((t4 & -2147483648) + ((t6.x ? t6.x == 31744 ? t7 + 2139095040 : ((((uint)t5 >> 10) * 8388608) & 260046848) + 939524096 + t7 : t6.y ? 947912704 - (t14 * 8388608) + (((t6.y << t14) * 8192) & 8380416) : 0) & 2147475456)), asfloat(t16) * packing.y, 1);
}
