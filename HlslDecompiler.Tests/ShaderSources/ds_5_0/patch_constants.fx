...
{
	float3 t0 = patch[0].position * sv_domainlocation.x + sv_domainlocation.y * patch[1].position + patch[2].position * sv_domainlocation.z + constants.normal * constants.inside;
